...
import { RECOMMENDED_PRODUCTS } from '@/app/[lang]/mocks/recommended-products';
    ...
    <Swiper
      ...
      {RECOMMENDED_PRODUCTS.map(product => (
        <SwiperSlide key={product.id}>
          <ProductCard title={product.title} contextualImg={product.images.contextual} whiteBgImg={product.images.whiteBg} price={product.price} />
        </SwiperSlide>
      ))}
      <div
