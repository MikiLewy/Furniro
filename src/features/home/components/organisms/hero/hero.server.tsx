...
const ServerHero = () => {
  return (
    <header
      ...
      <div className="bg-transparent horizontal-spacing flex flex-col text-center items-center justify-center sm:max-w-lg md:max-w-xl lg:max-w-4xl  relative z-2 gap-2 md:gap-4 lg:gap-6 ">
